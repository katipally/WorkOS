...
>(
  (
    ...
    if (isMobileView) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          <SheetOverlay className="top-[60px]" />
          <SheetContent
            data-sidebar="sidebar"
            data-mobile="true"
            className="bg-sidebar text-sidebar-foreground top-[60px] w-(--sidebar-width) border-none p-0 shadow-none [&>button]:hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="text-sidebar-foreground group peer absolute top-0 left-0 hidden md:block"
        data-state={state}
