...
`),
    ...
    RegExpValidationState3.prototype.at = function at(i3, forceU) {
      if (forceU === undefined)
        forceU = false;
      var s = this.source;
      var l = s.length;
    ...
    RegExpValidationState3.prototype.nextIndex = function nextIndex(i3, forceU) {
      if (forceU === undefined)
        forceU = false;
      var s = this.source;
      var l = s.length;
...
// source/errors/NullishShortCircuit.ts
...
var camelCase = (string) => string.replace(/([A-Z])([A-Z])/g, "$1 $2").replace(/([a-z])([A-Z])/g, "$1 $2").replace(/[^a-zA-Z\u00C0-\u00ff]/g, " ").toLowerCase().split(" ").filter((value) => value).map((s, i2) => i2 > 0 ? s[0].toUpperCase() + s.slice(1) : s).join("");
  ...
  #parseExpression = (expression, scope) => {
    switch (expression.type) {
      ...
      case "JSXText":
        ...
        return this.props.disableFragments ? expression.value : /* @__PURE__ */ React.createElement(Fragment, {
          key
        }, expression.value);
      case "ArrayExpression":
